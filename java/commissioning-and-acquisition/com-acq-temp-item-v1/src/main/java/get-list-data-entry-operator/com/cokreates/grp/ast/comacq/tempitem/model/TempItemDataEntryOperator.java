...
@Getter
@Setter
public class TempItemDataEntryOperator {

    private @Expose String oid, code, procurementMethod, description, status, vendorOid, vendorNameEn, vendorNameBn, createdBy, updatedBy;
