...
public class GetListRowMapperStoreManager implements RowMapper<TempItemStoreManager> {
	
	public TempItemStoreManager mapRow(ResultSet rs, int rowNum) throws SQLException {
		
		TempItemStoreManager entity = new TempItemStoreManager();
