...
public class GetListQueryStoreManager {
	
	@Synchronized
    public static ImmutablePair<String, Object[]> getTemporaryItemSql(AuthUser user, GetListRequestStoreManager request) {
        
    	List<Object> param = Lists.newArrayList(user.getOfficeOid(), Constant.TI_STATUS_DRAFT);
...
//       			   + " e where e.grp_username = t.received_by ) as receivedByEn "
    ...
    @Synchronized
    public static ImmutablePair<String, Object[]> getDataCountSql(AuthUser user, GetListRequestStoreManager request) {
