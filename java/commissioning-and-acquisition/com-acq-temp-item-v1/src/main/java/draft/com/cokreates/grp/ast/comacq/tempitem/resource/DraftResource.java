...
import com.cokreates.grp.ast.comacq.tempitem.response.DraftResponseBody;
import com.cokreates.grp.ast.comacq.tempitem.service.DraftService;
...
@Slf4j
@RestController("comAcqTempItemV1DraftResource")
...
public class DraftResource {
	...
	@Autowired
	@Qualifier("comAcqTempItemV1DraftService")
	private DraftService service;

	// @HystrixCommand(fallbackMethod = "fallbackGetAllOnPost")
	@PostMapping(path = Api.COMACQ_TEMPITEM_V1_DRAFT_PATH, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody DraftResponse onPost(@Valid @RequestBody DraftRequest request, @RequestHeader(value="Authorization") String token) throws AppException {
		String url = Api.COMACQ_TEMPITEM_V1_RESOURCE.concat(Api.COMACQ_TEMPITEM_V1_DRAFT_PATH);
