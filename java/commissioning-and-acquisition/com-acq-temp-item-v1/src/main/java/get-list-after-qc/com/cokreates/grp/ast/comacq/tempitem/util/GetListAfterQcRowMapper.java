...
public class GetListAfterQcRowMapper implements RowMapper<TempItemAfterQc> {
	
	public TempItemAfterQc mapRow(ResultSet rs, int rowNum) throws SQLException {
		
		TempItemAfterQc entity = new TempItemAfterQc();
