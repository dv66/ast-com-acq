...
import com.cokreates.grp.ast.comacq.tempitem.util.GetListAfterQcQuery;
import com.cokreates.grp.ast.comacq.tempitem.util.GetListAfterQcRowMapper;
...
@Slf4j
@Repository("comAcqTempItemV1GetListAfterQcDao")
public class GetListAfterQcDao {
    ...
    @Transactional
    public List<TempItemAfterQc> findAll(GetListAfterQcRequest request, AuthUser user) {
        ImmutablePair<String, Object[]> query = GetListAfterQcQuery.getTemporaryItemSql(request, user);
        List<TempItemAfterQc> result = jdbcTemplate.query(query.getLeft(), query.getRight(), new GetListAfterQcRowMapper());
    ...
    @Transactional
    public int getDataCount(AuthUser user, GetListAfterQcRequest request) {
        ImmutablePair<String, Object[]> query = GetListAfterQcQuery.getDataCountSql(request, user);
