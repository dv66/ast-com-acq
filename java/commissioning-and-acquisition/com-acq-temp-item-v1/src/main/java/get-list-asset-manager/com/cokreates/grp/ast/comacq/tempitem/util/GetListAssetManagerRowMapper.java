...
public class GetListAssetManagerRowMapper implements RowMapper<TempItemAssetManager> {
	
	public TempItemAssetManager mapRow(ResultSet rs, int rowNum) throws SQLException {
		
		TempItemAssetManager entity = new TempItemAssetManager();
