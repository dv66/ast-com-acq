...
public class GetListAssetManagerQuery {
	
	@Synchronized
    public static ImmutablePair<String, Object[]> getTemporaryItemSql(GetListRequestAssetManager request, String officeOid) {
        
    	List<Object> param = Lists.newArrayList(officeOid, Constant.TI_STATUS_DRAFT);
    ...
    @Synchronized
    public static ImmutablePair<String, Object[]> getDataCountSql(GetListRequestAssetManager request, String officeOid) {
