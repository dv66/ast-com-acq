...
public class GetListRowMapper implements RowMapper<TempItem> {
	
	public TempItem mapRow(ResultSet rs, int rowNum) throws SQLException {
		
		TempItem entity = new TempItem();
