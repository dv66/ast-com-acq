...
public class GetListRowMapperCommittee implements RowMapper<TempItemCommittee> {
	
	public TempItemCommittee mapRow(ResultSet rs, int rowNum) throws SQLException {
		
		TempItemCommittee entity = new TempItemCommittee();
