...
import com.cokreates.grp.ast.comacq.tempitem.response.SaveResponseBody;
import com.cokreates.grp.ast.comacq.tempitem.service.SaveService;
...
@Slf4j
@RestController("comAcqTempItemV1SaveResource")
...
public class SaveResource {
	...
	@Autowired
	@Qualifier("comAcqTempItemV1SaveService")
	private SaveService service;

	// @HystrixCommand(fallbackMethod = "fallbackGetAllOnPost")
	@PostMapping(path = Api.COMACQ_TEMPITEM_V1_SAVE_PATH, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody SaveResponse onPost(@Valid @RequestBody SaveRequest request, @RequestHeader(value="Authorization") String token) throws AppException {
		String url = Api.COMACQ_TEMPITEM_V1_RESOURCE.concat(Api.COMACQ_TEMPITEM_V1_SAVE_PATH);
