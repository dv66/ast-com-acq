...
import com.cokreates.grp.ast.comacq.assetinfo.service.GetByOidService;
...
@Slf4j
@RestController("comacqAssetInfoV1GetByOidResource")
...
public class GetByOidResource {
	...
	@Autowired
	@Qualifier("comacqAssetInfoV1GetByOidService")
	private GetByOidService service;

	// @HystrixCommand(fallbackMethod = "fallbackGetAllOnPost")
	@PostMapping(path = Api.COMACQ_ASSETINFO_V1_GET_BY_OID_PATH, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody GetByOidResponse onPost(@Valid @RequestBody GetByOidRequest request, @RequestHeader(value="Authorization") String token) throws AppException {
		String url = Api.COMACQ_ASSETINFO_V1_RESOURCE.concat(Api.COMACQ_ASSETINFO_V1_GET_BY_OID_PATH);
