...
import com.cokreates.grp.ast.comacq.assetinfo.response.GetListResponseBody;
import com.cokreates.grp.ast.comacq.assetinfo.service.GetService;
...
@Slf4j
@RestController("comacqAssetInfoV1GetListResource")
...
public class GetListResource {
	...
	@Autowired
	@Qualifier("comacqAssetInfoV1GetService")
	private GetService service;

	// @HystrixCommand(fallbackMethod = "fallbackGetAllOnPost")
	@PostMapping(path = Api.COMACQ_ASSETINFO_V1_GET_LIST_PATH, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody GetListResponse onPost(@Valid @RequestBody GetListRequest request, @RequestHeader(value="Authorization") String token) throws AppException {
		String url = Api.COMACQ_ASSETINFO_V1_RESOURCE.concat(Api.COMACQ_ASSETINFO_V1_GET_LIST_PATH);
