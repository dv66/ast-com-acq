...
public class GetByOidAfterTaggingQuery {

	@Synchronized
	public static ImmutablePair<String, Object[]> getAssetInfoAfterTaggingSql(AuthUser user,String oid) {
		
		String sql = "select t.code as Code, t.description as Description, t.status as Status, t.tagged_by as TaggedBy, t.tagged_on as TaggedOn, t.created_by as CreatedBy,"
			+ " t.created_on as CreatedOn, t.updated_by as UpdatedBy, t.updated_on as UpdatedOn, i.code as TempCode, "
			+ " i.qc_by as qcBy, i.qc_on as qcOn, i.asset_added_by as assetAddedBy, i.asset_added_on as assetAddedOn, "
			+ " t.item_oid as itemOid "
//			+ " ( select name_bn from " + Table.SCHEMA_HRM + Table.EMPLOYEE_MASTER_INFO 
//			+ " e where e.grp_username = t.tagged_by ) as taggedByBn, "
//			+ " ( select name_en from " + Table.SCHEMA_HRM + Table.EMPLOYEE_MASTER_INFO 
//			+ " e where e.grp_username = t.tagged_by ) as taggedByEn, "
//			+ " ( select name_bn from " + Table.SCHEMA_HRM + Table.EMPLOYEE_MASTER_INFO 
...
//			+ " e where e.grp_username = i.asset_added_by ) as assetAddedByEn "
		...
		List<Object> data = Lists.newArrayList(oid, Constant.AI_STATUS_AVAILABLE);
