...
import com.cokreates.grp.ast.comacq.directin.response.SaveResponseBody;
import com.cokreates.grp.ast.comacq.directin.service.SaveService;
...
@Slf4j
@RestController("comAcqDirectInV1SaveResource")
...
public class SaveResource {
	...
	@Autowired
	@Qualifier("comAcqDirectInV1SaveService")
	private SaveService service;

	// @HystrixCommand(fallbackMethod = "fallbackGetAllOnPost")
	@PostMapping(path = Api.COMACQ_DIRECTIN_V1_SAVE_PATH, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody SaveResponse onPost(@Valid @RequestBody SaveRequest request, @RequestHeader(value="Authorization") String token) throws AppException {
		String url = Api.COMACQ_DIRECTIN_V1_RESOURCE.concat(Api.COMACQ_DIRECTIN_V1_SAVE_PATH);
