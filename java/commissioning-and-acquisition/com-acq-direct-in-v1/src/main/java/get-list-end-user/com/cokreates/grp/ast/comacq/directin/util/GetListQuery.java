...
public class GetListQuery {
	...
	@Synchronized
    public static ImmutablePair<String, Object[]> getDirectInSql(GetListRequest request, AuthUser user ) {
        
    	List<Object> param = Lists.newArrayList(user.getOfficeOid(),user.getUserOid());
    	
        String sql = "select t.oid as oid, t.code as code, t.status as status "
