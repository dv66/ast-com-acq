...
import com.cokreates.grp.ast.comacq.directin.response.GetListApprovalResponseBody;
import com.cokreates.grp.ast.comacq.directin.service.GetApprovalService;
...
@Slf4j
@RestController("comAcqDirectInV1GetListApprovalResource")
...
public class GetListApprovalResource {
	...
	@Autowired
	@Qualifier("comAcqDirectInV1GetListApprovalService")
	private GetApprovalService service;

	// @HystrixCommand(fallbackMethod = "fallbackGetAllOnPost")
	@PostMapping(path = Api.COMACQ_DIRECTIN_V1_GET_LIST_APPROVAL_PATH, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody GetListApprovalResponse onPost(@Valid @RequestBody GetListApprovalRequest request, @RequestHeader(value="Authorization") String token) throws AppException {
		String url = Api.COMACQ_DIRECTIN_V1_RESOURCE.concat(Api.COMACQ_DIRECTIN_V1_GET_LIST_APPROVAL_PATH);
