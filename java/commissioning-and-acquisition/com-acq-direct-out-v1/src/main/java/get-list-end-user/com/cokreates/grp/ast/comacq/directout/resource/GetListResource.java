...
import com.cokreates.grp.ast.comacq.directout.response.GetListResponseBody;
import com.cokreates.grp.ast.comacq.directout.service.GetService;
...
@Slf4j
@RestController("comAcqDirectOutV1GetListEndUserResource")
...
public class GetListResource {
	...
	@Autowired
	@Qualifier("comAcqDirectOutV1GetListEndUserService")
	private GetService service;

	// @HystrixCommand(fallbackMethod = "fallbackGetAllOnPost")
	@PostMapping(path = Api.COMACQ_DIRECTOUT_V1_GET_LIST_END_USER_PATH, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody GetListResponse onPost(@Valid @RequestBody GetListRequest request, @RequestHeader(value="Authorization") String token) throws AppException {
		String url = Api.COMACQ_DIRECTOUT_V1_RESOURCE.concat(Api.COMACQ_DIRECTOUT_V1_GET_LIST_END_USER_PATH);
