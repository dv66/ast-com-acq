...
import com.cokreates.grp.ast.comacq.directout.response.SaveResponseBody;
import com.cokreates.grp.ast.comacq.directout.service.SaveService;
...
@Slf4j
@RestController("comAcqDirectOutV1SaveResource")
...
public class SaveResource {
	...
	@Autowired
	@Qualifier("comAcqDirectOutV1SaveService")
	private SaveService service;

	// @HystrixCommand(fallbackMethod = "fallbackGetAllOnPost")
	@PostMapping(path = Api.COMACQ_DIRECTOUT_V1_SAVE_PATH, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	public @ResponseBody SaveResponse onPost(@Valid @RequestBody SaveRequest request, @RequestHeader(value="Authorization") String token) throws AppException {
		String url = Api.COMACQ_DIRECTOUT_V1_RESOURCE.concat(Api.COMACQ_DIRECTOUT_V1_SAVE_PATH);
